        ...
        <div class="row">
            <div class="col-md">
                <form action="/LoginAuth" method="post">
                    <div style="font-size: 22px;padding-bottom: 5px;">Sign in</div>
                    <label style="color: red;">${error}</label>
                    
                    <div class="form-group">
                        <label style="font-size: 14px;font-weight: bold;">Mobile number or Email</label>
                        <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp"
                            placeholder="Mobile number or email" name="username" required>
                    ...
                    <a href="/signup" class="btn btn-warning" id="grey-button">Create your Amazon account</a>
