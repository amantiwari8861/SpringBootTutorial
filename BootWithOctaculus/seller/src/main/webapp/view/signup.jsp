...
<body>
    ...
    <div class="d-flex flex-row justify-content-center">
        <div class="row">
            <div class="col-md">
                <form action="/validate-signup" method="post" modelAttribute="Seller">
                    <div style="font-size: 22px;padding-bottom: 5px;">Create account</div>
                    ...
                    <div class="form-group">
                        <label style="font-size: 14px;font-weight: bold;">Last name</label>
                        <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp"
                            placeholder="Last name" name="lname" required>
                        <small id="emailHelp" class="form-text text-muted"></small>
                    </div>
                    <div class="form-group">
                        <label style="font-size: 14px;font-weight: bold;">Mobile number</label>
                        <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp"
                    ...
                    <div class="form-group">
                        <label style="font-size: 14px;font-weight: bold;">Re-enter password</label>
                        <input type="password" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp"
                            placeholder="" name="rpassword" required>
                        <small id="emailHelp" class="form-text text-muted"></small>
                    </div>
                    <div class="form-group">
                        <div class="form-group">
                            <button type="submit" class="btn btn-warning" id="sign-in">Create your Amazon account</button>                            
                        </div>
                    </div>
                    <a href="/signin" class="btn btn-warning" id="grey-button">Sign In</a>
