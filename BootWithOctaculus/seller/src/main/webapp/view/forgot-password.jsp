        ...
        <div class="row">
            <div class="col-md">
                <form action="/verifyEmail" method="post">
                    <div style="font-size: 22px;padding-bottom: 5px;">Recover account</div>
                    <label style="color: red;">${error}</label>
                    
                    <div class="form-group">
                        <label style="font-size: 14px;font-weight: bold;">Enter your email registered with Amazon</label>
                        <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp"
                            placeholder="Enter yout email" name="email" required>
