        ...
        <div class="row">
            <div class="col-md">
                <form action="/ChangePassword" method="post">
                    <div style="font-size: 22px;padding-bottom: 5px;">Change password</div>
                    ...
                    <div class="form-group">
                        <label style="font-size: 14px;font-weight: bold;">Retype new password</label>
                    ...
                    <div class="form-group">
                        <div class="form-group">
                            <button type="submit" class="btn btn-warning" id="sign-in">Change</button>                            
                        </div>
                    </div>
                </form>
            </div><!--Col 1 End-->
