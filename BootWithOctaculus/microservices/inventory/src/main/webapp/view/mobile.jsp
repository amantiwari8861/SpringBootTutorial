                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-12 col-sm-6">
                                <h3 class="d-inline-block d-sm-none">${mobile.getProductTitle()}</h3>
                                <div class="col-12">
                            ...
                            <div class="col-12 col-sm-6">
                                <h3 class="my-3">${mobile.getProductTitle()}</h3>
                                <p>${mobile.getShortDescription()}</p>
                                ...
                                <div class="mt-4">
                                    ...
                                    <h4 class="mt-0">
                                        <small>MRP: <s>&#x20B9; ${mobile.getMrp()}</s> </small>
                                    </h4>
                                </div>
                                ...
                                <div class="mt-4">
                                    ...
                                    <table>
                                        ...
                                        <tr>
                                            ...
                                            <td>${mobile.getWirelessCarrier()}</td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>${mobile.getCellularTechnology()}</td>
                                        </tr>
                                        <tr>
                                            <td>Memory Storage Capacity</td>
                                            <td>${mobile.getMemoryStorageCapacity()} GB</td>
                                        </tr>
                                        <tr>
                                            <td>Internal Storage Capacity</td>
                                            <td>${mobile.getInternalMemory()} GB</td>
                                        </tr>
                                        <tr>
                                            <td>Connectivity Technology</td>
                                            <td>${mobile.getConnectivityTechnology()}</td>
                                        </tr>
                                        <tr>
                                            <td>Screen Size</td>
                                            <td>${mobile.getScreenSize()} inch</td>
                                        </tr>
                                        <tr>
                                            <td>Battery Capacity</td>
                                            <td>${mobile.getBatteryCapacity()} MAH</td>
                                        </tr>
                                    </table>
                                </div>
                        ...
                        <div class="row mt-4">
                            ...
                            <div class="tab-content p-3" id="nav-tabContent">
                                <div class="tab-pane fade show active" id="product-desc" role="tabpanel"
                                    aria-labelledby="product-desc-tab">${mobile.getProductDescription()}</div>
